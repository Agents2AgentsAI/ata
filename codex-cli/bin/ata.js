#!/usr/bin/env node
// Unified entry point for the Ata CLI.
...
try {
  ...
  if (existsSync(localBinaryPath)) {
    ...
    const updateCommand =
      packageManager === "bun"
        ? "bun install -g @a2a-ai/ata@latest"
        : "npm install -g @a2a-ai/ata@latest";
    throw new Error(
      `Missing optional dependency ${platformPackage}. Reinstall Ata: ${updateCommand}`,
    );
  }
}
...
/**
 * Use heuristics to detect the package manager that was used to install Ata
