...
<p align="center"><code>npm i -g @a2a-ai/ata</code></p>
...
npm install -g @a2a-ai/ata
# or
yarn global add @a2a-ai/ata
# or
bun install -g @a2a-ai/ata
# or
pnpm add -g @a2a-ai/ata
```
...
You may need to upgrade to a more recent version with: `npm i -g @a2a-ai/ata@latest`
