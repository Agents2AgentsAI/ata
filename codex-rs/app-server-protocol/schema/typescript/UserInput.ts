 ...
 */
text_elements: Array<TextElement>, } | { "type": "image", image_url: string, } | { "type": "local_image", path: string, } | { "type": "skill", name: string, path: string, } | { "type": "mention", name: string, path: string, } | { "type": "local_file", path: string, } | { "type": "uploaded_file", file_id: string, mime_type: string, filename: string, source_path: string, };
