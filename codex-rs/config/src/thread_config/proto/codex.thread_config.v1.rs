...
impl WireApi {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::GeminiGenerate => "WIRE_API_GEMINI_GENERATE",
            Self::CopilotInline => "WIRE_API_COPILOT_INLINE",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "WIRE_API_GEMINI_GENERATE" => Some(Self::GeminiGenerate),
            "WIRE_API_COPILOT_INLINE" => Some(Self::CopilotInline),
            _ => None,
        }
    }
}
