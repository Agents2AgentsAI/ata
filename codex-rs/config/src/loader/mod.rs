...
use codex_utils_git::resolve_root_git_project_for_trust;
...
///   `%ProgramData%\Agents2Agents\Ata\requirements.toml` (Windows)
///
...
///
/// See https://github.com/Agents2AgentsAI/ata/blob/main/docs/sandbox.md for details.
///
