...
use crate::tools::spec::ExternalTool;
use crate::tools::spec::ToolsConfig;
use crate::tools::spec::build_specs_with_discoverable_tools;
use crate::tools::spec::build_specs_with_toolkits;
...
impl ToolRouter {
    ...
    pub fn from_config_with_toolkits(
        ...
        if research_toolkit.is_none() && data_toolkit.is_none() {
            return Self::from_config(config, params);
        }
    ...
    /// Like [`Self::from_config_with_toolkits`] but also registers
    /// externally-provided tools.
    #[allow(dead_code)]
    pub fn from_config_with_external_tools(
        config: &ToolsConfig,
        params: ToolRouterParams<'_>,
        research_toolkit: Option<&Arc<SharedResearchToolkit>>,
        data_toolkit: Option<&Arc<SharedDataToolkit>>,
        ...
        let builder = build_specs_with_toolkits_and_external(
            config,
            mcp_tools,
            app_tools,
            discoverable_tools,
