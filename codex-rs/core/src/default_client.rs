...
pub fn build_reqwest_client_with_timeouts(
    ...
    try_build_reqwest_client_with_timeouts(connect_timeout, request_timeout).unwrap_or_else(
        |error| {
...
pub fn try_build_reqwest_client() -> Result<reqwest::Client, BuildCustomCaTransportError> {
    try_build_reqwest_client_with_timeouts(None, None)
}

fn try_build_reqwest_client_with_timeouts(
    connect_timeout: Option<Duration>,
    request_timeout: Option<Duration>,
