# Individual Contributor License Agreement (v1.0, Agents2Agents AI)
...
past and future "Contributions" submitted to the **Agents2Agents Ata project
(the "Project")**.
...
You grant **Agents2Agents AI, Inc.** and all recipients of software distributed by the
...
You grant **Agents2Agents AI, Inc.** and all recipients of the Project a perpetual,
